...
/**
 * The root course completion credential application component.
 *
 * @remarks
 * The {@link App} component requires a `<DeployedCredentialProvider />` parent in order to retrieve
 * information about current course completion credential deployments.
 *
 * @internal
 */
const App: React.FC = () => {
