...
/*
 * This file defines the shape of the course credential's private state,
 * as well as the single witness function that accesses it.
 */

import { Ledger } from "./managed/course-credential/contract/index.js";
import { WitnessContext } from "@midnight-ntwrk/midnight-js-protocol/compact-runtime";

/* **********************************************************************
 * The only hidden state needed by the course credential contract is
 * the issuer's secret key.  Some of the library code and
...
export type CourseCredentialPrivateState = {
  readonly secretKey: Uint8Array;
};

export const createCourseCredentialPrivateState = (secretKey: Uint8Array) => ({
  secretKey,
});

/* **********************************************************************
 * The witnesses object for the course credential contract is an object
 ...
 * is the private state type, like CourseCredentialPrivateState defined above.
 *
 ...
 * the declared return value.  In this case, that's a CourseCredentialPrivateState
...
export const witnesses = {
  localSecretKey: ({
    privateState,
  }: WitnessContext<Ledger, CourseCredentialPrivateState>): [
